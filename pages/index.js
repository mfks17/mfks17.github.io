        ...
        <div className="container">
          <div className="row">
            ...
            <div className="column-small-9">
              <p>
                I'm <a href="https://twitter.com/mfks17" target="_blank">@mfks17</a>,
                a programmer and music lover from Kanagawa, Japan.
              </p>
              <p>
          ...
          <div className="row">
            ...
            <div className="column-small-4">
              <a href="https://twitter.com/mfks17" target="_blank" className="activity">
                <div className="activity-image" style={{ backgroundImage: "url(https://dl.dropboxusercontent.com/u/41130551/1485003054_bird_twitter.png)" }}/>
                <div className="activity-heading">
                  Tweet
                </div>
              </a>
